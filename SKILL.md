...
The Docker image is `mosqueiro/yt-manager:0.0.4` on Docker Hub.
...
services:
  app:
    image: mosqueiro/yt-manager:0.0.4
    ports:
      - "3000:3000"
    volumes:
      - data:/app/data
...
The version is shown at the bottom of the sidebar in the app (e.g. `v0.0.4`).
